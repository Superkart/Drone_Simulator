...
void UCitySampleCrowdVisualizationFragmentInitializer::Execute(UMassEntitySubsystem& EntitySubsystem, FMassExecutionContext& Context)
{
	...
	if (CVarUseMetahumanPresets.GetValueOnGameThread() == true)
	{
		...
		if (UCrowdPresetDataAsset* PresetDataAsset = Cast<UCrowdPresetDataAsset>(PresetDataAssetPath.TryLoad()))
		{
			...
			{
				EntityQuery.ForEachEntityChunk(EntitySubsystem, Context, [this, Presets, RepresentationSubsystem](FMassExecutionContext& Context)
                {
	...
	EntityQuery.ForEachEntityChunk(EntitySubsystem, Context, [&, this, RepresentationSubsystem, CachedCrowdScalabilityValues, RandomStream](FMassExecutionContext& Context)
	{
		const TArrayView<FCitySampleCrowdVisualizationFragment> VisualizationList = Context.GetMutableFragmentView<FCitySampleCrowdVisualizationFragment>();
